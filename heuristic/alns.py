...
class ALNS:
    def __init__(self, state, criterion, data, objective_weights):
        ...
        operators = {
            ...
            remove_worst_week: [repair_worst_week_regret, repair_worst_week_greedy, repair_week_demand],
            remove_random_week: [repair_worst_week_regret, repair_worst_week_greedy, repair_week_demand],
            remove_weighted_random_week: [repair_worst_week_regret, repair_worst_week_greedy, repair_week_demand],
