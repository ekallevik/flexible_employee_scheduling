        ...
        if state.hard_vars["weekly_off_shift_error"][emp, j] == 1:
            ...
            for shift in shifts:
                ...
                for e_p in possible_employees:
                    ...
                    calculate_isolated_working_days(
                        current_state, [e_p], shifts_at_day, days_in_week
                    )
                    ...
                    objective_values[e_p, shift] = calc_weekly_objective_function(
                        state, competencies, time_periods_in_week, employees, [j], L_C_D
                    )[0]
            ...
            destroy_set.append(
                set_x(state, t_covered_by_shift, emp, employee[1][0], employee[1][1], 0)
            )
