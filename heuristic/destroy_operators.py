...
def worst_week_removal(competencies, time_periods_in_week, employees, weeks, L_C_D, shifts_in_week, t_covered_by_shift, state, destroy_size=1):
    #print("worst_week_removal is running")
    worst_k_weeks = calc_weekly_objective_function(state, competencies, time_periods_in_week, employees, weeks, L_C_D, destroy_size, "worst")
