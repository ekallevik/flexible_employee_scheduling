...
def worst_week_removal(competencies, time_periods_in_week, employees, weeks, L_C_D, shifts_in_week, t_covered_by_shift, state):
...
def worst_employee_removal(shifts, t_covered_by_shift, state, destroy_size=1):
