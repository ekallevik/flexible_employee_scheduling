...
def worst_employee_removal(shifts, t_covered_by_shift, competencies, state, destroy_size=2):
    ...
    destroy_set = [remove_x(state, t_covered_by_shift, competencies, e, t, v) for e in employees for t,v in shifts if state.x[e,t,v] != 0]
