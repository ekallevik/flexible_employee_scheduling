...
def test_get_variables_returns_none():
    """ The base model should not contain any variables """

    base_model = get_base_model("problem12")

    assert not base_model.get_variables()
