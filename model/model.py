...
#       -------------WORK ALLOCATION-------------
        self.con_mapping_shift_to_demand()
        self.cover_max_one_demand()
        self.maximum_daily_shift()
        self.no_demand_cover_while_off_shift()
        self.allocate_to_work_when_covering_demand()


#       -------------REST-------------
        self.minimum_daily_rest()
        self.minimum_weekly_rest()


#       -------------CONTRACTED HOURS-------------
        self.less_than_contracted_hours()
...
#       -------------CONSECUTIVE WORKING DAYS-------------
        self.consecutive_working_days()

#       -------------OBJECTIVE RESTRICTION-------------
        self.objective_restriction()
